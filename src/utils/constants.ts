...
export const MOBILE_INTRO_PHRASE = `A full-stack engineer, trying to find a place in the world of instructions and logic; driven by this one simple philosophy — a few lines of code, simplest version of an idea, and the ability to make a dent in the universe. Based out of India, I am passionate about solving problems that makes the world more simple and memorable to experience. To sum up — a guy with the mind of an engineer, heart of an artist.`;
